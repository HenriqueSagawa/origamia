...
export default function Login () {
  return (
    <section className="bg-gray-100 py-20 dark:bg-black lg:py-[120px]">
      <div className="container mx-auto">
        <div className="-mx-4 flex flex-wrap">
          <div className="w-full px-4">
            <div className="relative mx-auto max-w-[525px] overflow-hidden rounded-lg bg-white px-10 py-16 text-center dark:bg-[#202A37] sm:px-12 md:px-[60px]">
              ...
              <p className="text-base text-body-color dark:text-dark-6">
                <span className="pr-0.5">Não possui conta? {" "}</span>
                <a
                  href="/#"
