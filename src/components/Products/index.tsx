...
export const Products = () => {        
    ...
    <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
        <div className="max-w-md mx-auto text-center">
            <h2 className="text-2xl font-bold text-gray-900 dark:text-gray-200 sm:text-3xl">Nossos itens em destaque</h2>
            <p className="mt-4 text-base font-normal leading-7 text-gray-600 dark:text-gray-400">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Purus faucibus massa dignissim tempus.</p>
        </div>

        <div className="grid grid-cols-2 gap-6 mt-10 lg:mt-16 lg:gap-4 lg:grid-cols-4">
            <div className="relative group">
                <div className="overflow-hidden aspect-w-1 aspect-h-1 bg-gray-700">
                ...
                <div className="flex items-start justify-between mt-4 space-x-4">
                    <div>
                        <h3 className="text-xs font-bold text-gray-900 dark:text-gray-300 sm:text-sm md:text-base">
                            <a href="#" title="">
                    ...
                    <div className="text-right">
                        <p className="text-xs font-bold text-gray-900 sm:text-sm md:text-base dark:text-gray-300">$99.00</p>
                    </div>
                </div>
            </div>
            ...
            <div className="relative group">
                ...
                <div className="flex items-start justify-between mt-4 space-x-4">
                    ...
                    <div className="text-right">
                        <p className="text-xs font-bold text-gray-900 sm:text-sm md:text-base dark:text-gray-300">$299.00</p>
                    </div>
                </div>
            </div>
            ...
            <div className="relative group">
                ...
                <div className="flex items-start justify-between mt-4 space-x-4">
                    <div>
                        <h3 className="text-xs font-bold text-gray-900 sm:text-sm md:text-base dark:text-gray-300">
                            <a href="#" title="">
                                Beylob 90 Speaker
                                <span className="absolute inset-0" aria-hidden="true"></span>
                            </a>
                    ...
                    <div className="text-right">
                        <p className="text-xs font-bold text-gray-900 sm:text-sm md:text-base dark:text-gray-300">$49.00</p>
            ...
            <div className="relative group">
                ...
                <div className="flex items-start justify-between mt-4 space-x-4">
                    ...
                    <div className="text-right">
                        <p className="text-xs font-bold text-gray-900 sm:text-sm md:text-base dark:text-gray-300">$79.00</p>
                    </div>
                </div>
            </div>
        </div>
