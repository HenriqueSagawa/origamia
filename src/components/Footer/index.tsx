...
export const Footer = () => {
  return (
    <>
      <footer className="relative z-10 mx-auto max-w-7xl pb-10 pt-20 dark:bg-dark lg:pb-20 lg:pt-[120px]">
        <div className="container">
          <div className="-mx-4 flex flex-wrap">
            <div className="w-full px-4 sm:w-2/3 lg:w-3/12">
              <div className="mb-10 w-full">
                <a href="/#" className="flex gap-2  items-center mb-6 inline-block max-w-[160px]">
                  <GiFoldedPaper className="max-w-full" size={45} />
                  <span className="text-2xl font-semibold">Origamia</span>
                </a>
